...
class AuctionProduct(models.Model):
    prod_image = models.ImageField(upload_to="auction/", default="something.img")
    ...
    winner_email = models.CharField(max_length=122, default="default@gmail.com")
    second_email = models.CharField(max_length=122, default="default@gmail.com")
    graph = models.CharField(max_length=1000,default="")
